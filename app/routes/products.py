...
def list_products(
    ...
    for p in products:
        result.append(ProductOut(
            ...
            image_url=presign_get(p.image_key, expires_seconds) if p.image_key else None,
            collage_url=presign_get(p.collage_key, expires_seconds) if p.collage_key else None,
        ))
...
def get_product(
    ...
    return ProductOut(
        ...
        image_url=presign_get(product.image_key, expires_seconds),
        collage_url=presign_get(product.collage_key, expires_seconds),
    )