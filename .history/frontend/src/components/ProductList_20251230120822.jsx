...
import SideViewsModal from './SideViewsModal'
              ...
              <div key={product.id} className="product-card">
                ...
                {product.side_views_urls && Object.keys(product.side_views_urls).length > 0 && (
                  <div className="side-views-section">
                    <button 
                      className="side-views-toggle"
                      onClick={() => toggleViews(product.id)}
                    >
                      <span className="toggle-icon">{expandedViews[product.id] ? '▼' : '▶'}</span>
                      <span className="toggle-text">
                        🔄 Side Views ({Object.keys(product.side_views_urls).length} angles)
                      </span>
                    </button>
                    
                    {expandedViews[product.id] && (
