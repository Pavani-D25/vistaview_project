...
async def generate_cardinal_views_endpoint(
    ...
    Optimized for speed:
    - Reduced inference steps (20 vs 75)
    - Smaller image processing (256px)
    - Memory optimizations
    - Single angle only
    
    Response time: ~20-40 seconds for all 4 views (vs 5+ minutes before)
    """
    ...
    try:
        ...
        # 3️⃣ Generate 4 cardinal views (FAST)
        ...
        return {
            ...
            "performance": {
                ...
                "estimated_time": f"{num_steps * 5} seconds"
            }
        }
...
async def generate_multi_cardinal_views_endpoint(
    ...
    Warning: This generates 4 views × number of angles, so it takes longer
    """
