...
def list_products(
    ...
    for p in products:
        result.append(ProductOut(
            ...
            enhanced_image_url=get_image_url(p.enhanced_image_key, expires_seconds) if p.enhanced_image_key else None,
        ))
...
def get_product(
    ...
    return ProductOut(
        ...
        enhanced_image_url=get_image_url(product.enhanced_image_key, expires_seconds) if product.enhanced_image_key else None,
    )
    )