...
async def generate_side_views_endpoint(
    ...
    # Optional: enforce dimensions are present before generating views
    if product.dims_l is None or product.dims_w is None or product.dims_h is None:
        raise HTTPException(
            status_code=400,
            detail="Product dimensions are missing; cannot generate side views",
        )
    ...
    try:
        ...
        # 5️⃣ Upload generated views to MinIO
        side_views_keys = {}
