...
class Product(Base):
    ...
    enhanced_image_key = Column(String, nullable=True)  # e.g., "images/session/enhanced/p001.jpg"
    left_view_key = Column(String, nullable=True)  # e.g., "images/session/sideviews/p001_left.jpg"
    right_view_key = Column(String, nullable=True) # e.g., "images/session/sideviews/p001_right.jpg"
