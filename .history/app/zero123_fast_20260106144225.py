...
def preprocess_image_fast(image: Image.Image, target_size: int = 256) -> Image.Image:
    """Fast preprocessing for Zero123 - optimized for speed"""
    # Convert to RGB
    if image.mode != 'RGB':
...
if DEPENDENCIES_AVAILABLE:
    class FastZero123Generator:
        ...
        def __init__(self, device: Optional[str] = None):
            ...
            self.default_size = 256  # Smaller = faster
            self.default_steps = 20  # Fewer steps = faster (was 75)
            self.default_guidance = 3.0
        ...
        def generate_view(
            ...
            try:
                ...
                # Resize back to reasonable size
                output_size = (512, 512)  # Fixed output size
