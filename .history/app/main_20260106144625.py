...
from .routes.generate_views import router as generate_views_router
from .routes.cardinal_views import router as cardinal_views_router
...
app.include_router(generate_views_router, prefix="/api/products", tags=["view-generation"])
app.include_router(cardinal_views_router, prefix="/api/products", tags=["cardinal-views"])
